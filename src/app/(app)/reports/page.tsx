                          ...
                          <DialogContent title={r.title} desc={`${r.period} · ${r.author}`}>
                            <div className="space-y-4 px-5 py-4">
                              <div className="rounded-md border border-ink-200 bg-ivory-100/60 px-4 py-3">
                                <p className="text-[15.5px] text-ink-400">핵심 요약</p>
                                <p className="mt-1 text-[17.5px] text-ink-800">{r.summary}</p>
                              </div>
                              <div>
                                <p className="mb-2 text-[16px] font-medium text-ink-700">
                                  회사별 매출 추이
                                </p>
                              ...
                              <div className="grid grid-cols-2 gap-3">
                                <div className="rounded-md border border-tailor-200/70 bg-tailor-50/40 p-3">
                                  <p className="text-[15.5px] text-tailor-700">비앤테일러샵</p>
                                  <p className="mt-1 text-[20.5px] font-semibold text-ink-800 num">
                                    {won(SUMMARY.tailor.revenue)}
                                  </p>
                                  <p className="mt-1 text-[15px] text-ink-400 num">
                                    자금 집행률 {pct(tExec, tPlan)}% · 계획 {wonShort(tPlan)}
                                  </p>
                                </div>
                                <div className="rounded-md border border-corp-200/70 bg-corp-50/40 p-3">
                                  <p className="text-[15.5px] text-corp-700">AI 소프트웨어 법인</p>
                                  <p className="mt-1 text-[20.5px] font-semibold text-ink-800 num">
            ...
            <div className="grid grid-cols-2 divide-x divide-y divide-ink-100">
              {[
                ...
                <div key={r.l} className="px-4 py-3">
                  ...
                  <p className="mt-1 text-[17.5px] font-semibold text-ink-800 num">{r.v}</p>
                </div>
              ))}
            </div>
          </Card>
