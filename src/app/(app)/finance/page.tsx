      ...
      <div className="mb-3 flex items-center gap-1 rounded-md border border-ink-200 bg-white p-0.5 shadow-card sm:inline-flex">
        {TABS.map((t) => (
          <button
            ...
            className={cn(
              "flex-1 rounded px-4 py-1.5 text-[17px] font-medium transition-colors sm:flex-none",
              scope === t.value
                ? t.value === "tailor"
        ...
        <Card className="col-span-2 lg:col-span-1">
          <div className="flex h-full items-center gap-3 p-4">
            <div className="min-w-0 flex-1">
              <p className="text-[16px] text-ink-500">집행률</p>
              <p className="mt-1.5 text-[27.5px] font-semibold text-ink-900 num">
                {pct(executed, planned)}%
              </p>
              <p className="mt-1 text-[15px] text-ink-400">계획 대비</p>
            </div>
            <RateDonut
              ...
              <Card key={c}>
                ...
                <div className="flex items-center gap-4 p-4">
                  ...
                  <div className="min-w-0 flex-1 space-y-2">
                    {cl.map((b) => (
                      <div key={b.id}>
                        <div className="flex items-center justify-between gap-2 text-[15.5px]">
          ...
          <Card className="h-full">
            ...
            <div className="grid grid-cols-2 items-center gap-2 p-3.5">
              ...
              <ul className="thin-scroll max-h-[200px] space-y-1.5 overflow-y-auto">
                {lines.map((b, i) => (
                  <li key={b.id} className="flex items-center gap-2 text-[15.5px]">
                    <span
                    ...
                    <Td>
                      <div className="flex items-center gap-2">
                        <Bar
                          ...
                          className="w-[70px]"
                        />
                        <span className="text-[15.5px] text-ink-500 num">{rate}%</span>
                      </div>
                    </Td>
                  </Tr>
                );
        ...
        <div className="col-span-12 xl:col-span-5">
          <Card className="h-full">
            ...
            <div className="p-3.5">
              ...
              <div className="mt-3 grid grid-cols-2 gap-2 border-t border-ink-100 pt-3 text-[15.5px]">
  ...
  return (
    <Card>
      <div className="p-4">
        ...
        <p className="mt-1.5 text-[25px] font-semibold text-ink-900 num">{value}</p>
        <p className="mt-1 text-[15px] text-ink-400">{sub}</p>
      </div>
    </Card>
  );
}
