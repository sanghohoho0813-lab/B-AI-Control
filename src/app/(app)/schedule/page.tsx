  ...
  return (
    <div className="animate-fade-in">
      ...
      <div className="mb-3 flex flex-wrap items-center gap-1.5">
        ...
        <span className="ml-auto text-[11.5px] text-ink-400">총 {items.length}건</span>
      </div>
                ...
                {dayItems.map((s) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <span className="w-11 shrink-0 text-[12px] font-medium text-ink-700 num">
                        {s.time}
                      </span>
      ...
      {items.length === 0 ? (
        <Card className="mt-3">
          <div className="px-4 py-12 text-center text-[12.5px] text-ink-400">
            조건에 맞는 일정이 없습니다.
          </div>
        </Card>
      ) : null}
