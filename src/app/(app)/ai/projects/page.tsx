          ...
          <Card key={p.id} className="overflow-hidden">
            ...
            <div className="p-3.5">
              <div className="flex items-start justify-between gap-2">
                <span className="text-[17.5px] font-semibold text-ink-800">{p.name}</span>
                <StatusBadge status={p.status} />
              </div>
              ...
              <div className="mt-2.5">
                <div className="flex items-center justify-between text-[15px] text-ink-400">
                  <span>개발 진행</span>
              ...
              <p className="mt-2.5 border-t border-ink-100 pt-2 text-[15px] text-ink-500">
                {p.nextMilestone}
              </p>
              <ProjectDetailModal project={p}>
