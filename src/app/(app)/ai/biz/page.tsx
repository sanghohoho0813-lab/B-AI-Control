                    ...
                    <Tr key={d.id}>
                      ...
                      <Td>
                        <div className="flex items-center gap-2">
                          ...
                          <span className="text-[15.5px] text-ink-500 num">{d.probability}%</span>
                        </div>
                      </Td>
                ...
                return (
                  <li key={s} className="border-b border-ink-100 py-2.5 last:border-b-0">
                    <div className="flex items-center justify-between">
                      ...
                      <span className="text-[17px] font-medium text-ink-800 num">{won(amt)}</span>
                    </div>
                    <div className="mt-1.5 flex items-center gap-2">
                      <Bar
                        ...
                        color="#234084"
                      />
                      <span className="w-14 shrink-0 text-right text-[15px] text-ink-400 num">
                        {list.length}건
                      </span>
                    </div>
                  </li>
