  ...
  return (
    <div className="animate-fade-in">
      ...
      <div className="grid grid-cols-2 gap-3 lg:grid-cols-4">
        <Card>
          <div className="p-4">
            <p className="text-[16px] text-ink-500">양사 합산 매출</p>
            <p className="mt-1.5 text-[27.5px] font-semibold text-ink-900 num">{won(total)}</p>
            <p className="mt-1 text-[15px] text-emerald-600 num">
        ...
        <Card className="stripe-tailor">
          <div className="p-4">
            <p className="text-[16px] text-tailor-700">비앤테일러샵</p>
        ...
        <Card className="stripe-corp">
          <div className="p-4">
            <p className="text-[16px] text-corp-700">AI 소프트웨어 법인</p>
            <p className="mt-1.5 text-[27.5px] font-semibold text-ink-900 num">
        ...
        <Card>
          <div className="p-4">
            <p className="text-[16px] text-ink-500">미수금 합계</p>
            <p className="mt-1.5 text-[27.5px] font-semibold text-ink-900 num">
