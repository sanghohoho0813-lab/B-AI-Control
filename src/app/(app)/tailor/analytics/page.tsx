          ...
          <Card className="h-full">
            ...
            <div className="p-3.5">
              ...
              <ul className="mt-2 space-y-1.5 border-t border-ink-100 pt-2.5">
                {gradeMix.map((g, i) => (
                  <li key={g.name} className="flex items-center gap-2 text-[15.5px]">
                ...
                return (
                  <li key={g} className="border-b border-ink-100 py-3 last:border-b-0">
                    <div className="flex items-center justify-between">
                      ...
                      <span className="text-[17px] font-medium text-ink-800 num">
                        {won(sum)}
                      </span>
                    </div>
                ...
                <Tr key={c.id}>
                  ...
                  <Td>
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-[15.5px] font-medium text-ink-700 num">
                        {c.repurchaseScore}
                      </span>
                    </div>
                  </Td>
