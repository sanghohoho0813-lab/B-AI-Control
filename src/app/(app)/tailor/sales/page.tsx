            ...
            <ul>
              {[...TAILOR_CUSTOMERS]
                ...
                .map((c) => (
                  ...
                  >
                    <span className="flex h-6 w-6 shrink-0 items-center justify-center rounded-full bg-tailor-50 text-[14.5px] font-semibold text-tailor-700">
                      {c.name.slice(0, 1)}
                    </span>
                    ...
                    <span className="shrink-0 text-[16px] font-medium text-ink-800 num">
