  ...
  return (
    <div className="flex h-full flex-col">
      ...
      <div className="border-b border-white/8 px-5 py-4">
        <Link href="/dashboard" onClick={onNavigate} className="block">
          <div className="flex items-baseline gap-1.5">
            <span className="text-[19px] font-semibold tracking-tight text-white">B&amp;AI</span>
            <span className="text-[19px] font-light tracking-[0.16em] text-white/70">CONTROL</span>
          </div>
          <p className="mt-1 text-[10px] leading-snug tracking-wide text-white/40">
      ...
      <div className="grid grid-cols-2 gap-1.5 px-3 py-2.5">
        ...
        >
          <span className="block text-[10px] font-medium tracking-tight text-white/70">
            비앤테일러샵
          </span>
          <span className="mt-1 flex items-center gap-1">
            ...
            <span className="text-[11px] font-semibold text-white/95 num">1억 2,845만</span>
          </span>
        </button>
        <button
        ...
        >
          ...
          <span className="mt-1 flex items-center gap-1">
            ...
            <span className="text-[11px] font-semibold text-white/95 num">8,732만</span>
          </span>
        </button>
      </div>
                ...
                return (
                  <li key={item.href}>
                    <Link
                      ...
                      onClick={onNavigate}
                      className={cn(
                        "group flex items-center gap-2.5 rounded-md px-2.5 py-[5.5px] text-[12.5px] transition-colors",
                        active
                          ? group.tone === "tailor"
...
export function Sidebar() {
  return (
    <aside
      className="fixed inset-y-0 left-0 z-40 hidden w-[228px] lg:block"
